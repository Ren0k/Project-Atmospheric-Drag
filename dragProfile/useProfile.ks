...
local getSAT is lib_AtmosphericFlightData["getFixedTemperature"](SGP, AMSL, 0).     // Static Air Temperature function - single geoposition  
local SAT is getSAT(AMSL).                                                          // Static Air Temperature
...
function showDrag {
    ...
    if counter > 100 {
        set getSAT to lib_AtmosphericFlightData["getFixedTemperature"](SGP, AMSL, 0).   // SAT Function Update, every 100 updates
